    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input wire:model="user_name" type="text" class="form-control" id="user_name" placeholder="User Name" @if($disabled) disabled='disabled' @endif>@error('user_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input wire:model="customer_mobile" type="text" class="form-control" id="customer_mobile" placeholder="Customer Mobile" @if($disabled) disabled='disabled' @endif>@error('customer_mobile') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
